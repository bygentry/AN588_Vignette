...
For an example where we only consider two genes and classes, lets start by calculating the values we need. The means are easy, but we have to make sure to distinguish between class AND gene.
